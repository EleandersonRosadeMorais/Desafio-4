...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a class="item" href="../php/diaSemana.php">Encontrar o maior valor</a></li>
                <li><a class="item" href="../index.php">Home</a></li>
                <li><a class="item" href="../php/mesExtenso.php">Calculadora de área e perímetro</a></li>
            </ul>
        </nav>
    </header>
    <div class="container">
        ...
        <form method="post" action="">
            <div class="form-group">
                ...
                <input type="text" step="any" id="n1" name="n1"
                    value="<?= (!empty($n1) && $n1 != '0') ? htmlspecialchars($n1) : '' ?>" placeholder="Ex: 10">
            </div>

            <div class="form-group">
                <label for="n2">Número 2</label>
                <input type="text" step="any" id="n2" name="n2"
                    value="<?= (!empty($n2) && $n2 != '0') ? htmlspecialchars($n2) : '' ?>" placeholder="Ex: 5">
            </div>
